...
app.layout = html.Div([
    ...
    html.Div([ 
        dcc.Input(
            ...
            style={'color': 'black','height':'30px', 'font-size': 17.5}
        )
    ...
    ], style={'color': 'black','width': '30%', 'margin': 'auto', 'padding': '10px'
    }),
...
def update_input_container(selected_statistics):
    if selected_statistics =='Yearly Statistics': 
        return 2018, False, None, True
    elif selected_statistics == 'Map Statistics':
        return None, True, list(legend_colors.keys()), False
    else: 
...
def update_output_container(selected_statistics, entered_year, entered_loi):
    if selected_statistics == 'Yearly Statistics' and entered_year:
        ...
        row_2 = html.Div([
            ...
            ], style={'display': 'flex', 'gap': '30px', 'height':'950px', 'justify-content': 'center'})
        ...
        fig4.update_layout(font ={'size': 25},
        ...
        chart5  = dcc.Graph(figure=fig4, style={'height': '1200px', 'width': '100%'})

        return [
            [html.Div([
                html.Div(row_1, style={'margin-bottom': '30px'}),  #Add gap below row_1
                html.Div(row_2)
            ],  style={'height':'1760px','width': '100%', 'margin-bottom': '40px'})],
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------
        ...
        fig5.update_layout(
            ...
            font ={'size': 25}, hoverlabel= {'font_size': 27}, showlegend=False
        )
        ...
        fig7.update_layout(font ={'size': 25}, hoverlabel= {'font_size': 27}, showlegend=False,
            margin=dict(t=120, b=60, l=40, r=40),
        ...
        fig9.update_layout(font ={'size': 25},
        ...
        chart6  = dcc.Graph(figure=fig9, style={'height': '1200px', 'width': '100%'})

        return [
            [html.Div([
                html.Div(row_3, style={'margin-bottom': '30px'}),  #Add gap below row_3
                html.Div(row_4)
            ], style={'height':'1960px','width': '100%', 'margin-bottom': '40px'})],
...
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------    
        ...
        fig12.update_layout(title_x= 0.5, font ={'size': 25} , hoverlabel= {'font_size': 27})     
        ...
        fig13.update_layout(legend_title_text='', font ={'size': 25}, hoverlabel= {'font_size': 27},
        ...
        ], style={'display': 'flex', 'gap': '20px', 'height':'850px', 'justify-content': 'center'})
        
        return [
            html.Div([
                html.Div(row_5, style={'margin-bottom': '30px'}),  #Add gap below row_5
                html.Div(row_6)
            ], style={'height': '900px', 'width': '100%','margin-bottom': '40px'}
            ), None        
        ]
#--------------------------------------------------------------------------------------------------------------------------------------------------------------------        
    else: 
